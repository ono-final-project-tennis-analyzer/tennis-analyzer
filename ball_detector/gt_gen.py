...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_input', type=str, help='path to input folder', default="input")
    parser.add_argument('--path_output', type=str, help='path to output folder', default="datasets/trackNet")

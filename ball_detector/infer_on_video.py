from ball_detector.model import BallTrackerNet
import torch
import cv2
from ball_detector.general import postprocess
...
class BallDetector:
    ...
    def to_video(self):
        ...
        frames, fps = read_video(self._video_path)
        ...
        write_track(frames, ball_track, self._video_out_path, fps)
...
if __name__ == '__main__':
    ...
    BallDetector(args.model_path, args.video_path, args.video_out_path, args.extrapolation).to_video()
